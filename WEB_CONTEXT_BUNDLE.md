...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kp-1.28-kirby-problem-1.28-253d5412-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KP-1.28"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kp-1.28-kirby-problem-1.28-253d5412-v1",
      "problem_contract_sha256": "61a3553c4d5aae2b968c62bf040e8d4039c637c41226cc724a3dc4c40ca81a4a",
      "problem_id": "problem:um-kp-1.28-kirby-problem-1.28-253d5412",
      "route_id": "route:um-kp-1.28-kirby-problem-1.28-253d5412-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kp-1.28-kirby-problem-1.28-253d5412-source-fidelity-01",
      "graph_id": "graph:um-kp-1.28-kirby-problem-1.28-253d5412-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kp-1.28-kirby-problem-1.28-253d5412-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kp-1.28-kirby-problem-1.28-253d5412-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $L$ be a link in the thickened annulus $S^{1} \\times I \\times I$. (a) Wrapping conjecture: $w(L)$ is equal to the maximal nonzero annular de- gree of the annular Kauffman bracket of $L$. (b) Categorifed wrapping conjecture: $w(L)$ is equal to the maximal nonzero annular grading of the annular Khovanov homology of $L$."
          },
          "statement_sha256": "dd6cee574ff6846208e66bdf8234d9b90870802b8448e48d5e9a48d4d5ff9f27"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kp-1.28-kirby-problem-1.28-253d5412-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kp-1.28-kirby-problem-1.28-253d5412-root",
      "route_id": "route:um-kp-1.28-kirby-problem-1.28-253d5412-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kp-1.28-118692020a46",
        "url": "https://www.unsolvedmath.com/problems/KP-1.28"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
